"""
Django settings for test_network_condition_simulator project.
...
SECRET_KEY = 'j4m0p*i1fb&lew(di!!c&z4h1xd(hben%#w9f60b21&=8%@yrt'
...
ROOT_URLCONF = 'test_network_condition_simulator.urls'
...
WSGI_APPLICATION = 'test_network_condition_simulator.wsgi.application'
