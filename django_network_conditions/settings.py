"""
Django settings for django_network_conditions project.
...
SECRET_KEY = 'einyhv0o1t^ght_jz9jvrul0l(a+r-2jzh%+)#4e&z(*q@5y$v'
...
WSGI_APPLICATION = 'django_network_conditions.wsgi.application'
